...
Creates all tables including verification tables and seeds data
"""
...
def seed_verified_companies():
    """Seed verified_companies table with sample data"""
    ...
    try:
        ...
        companies_data = [
            ...
            {"name": "NRLord", "domain": "nrlord.com", "industry": "Technology", "size": "1-100", "verified": True},
        ]
        
        # Use raw SQL for seeding to match the actual table schema
        seed_verified_sql = text("""
        ...
        with engine.connect() as conn:
            ...
            for company_data in companies_data:
                conn.execute(seed_verified_sql, {
            ...
            for company_data in companies_data:
                conn.execute(seed_companies_sql, {
                    ...
                    "industry": company_data["industry"],
                    "size": company_data["size"],
                    "is_verified": company_data["verified"]
                })
            
            conn.commit()
        
        print(f"✅ Seeded {len(companies_data)} verified companies")
        return True
...
if __name__ == "__main__":
    ...
    if not seed_verified_companies():
        print("⚠️  Failed to seed companies, but tables were created")
        sys.exit(1)
    
    print("🎉 Database setup completed successfully!")
    print("📋 All tables have been created and seeded")
    print("🔗 You can now connect to the database using pgAdmin at http://localhost:8080")
